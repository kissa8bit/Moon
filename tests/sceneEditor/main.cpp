...
std::pair<uint32_t, uint32_t> resize(moon::tests::GlfwWindow& window, moon::graphicsManager::GraphicsManager& app, scene& s) {
    window.resize();
...
int main()
{
    ...
    sceneEditor editor(app, window, ExternalPath);
